...
public class PermissionInterfaceVault extends PermissionInterface
{
	...
	public PermissionInterfaceVault()
	{
		...
		else
		{
			...
			Error err = new Error("Permission setup error!", "Vault permissions could NOT be set up correctly!",
					"MineFight will fail as long as vault isn't fixed!", this.getClass().getName(),
