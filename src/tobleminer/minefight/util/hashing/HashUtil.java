...
{
	/*
	 * IMPORTANT NOTICE! This class is NOT designed to be secure. It allows
	 * timing attacks and over pretty horrible stuff. Please, don't use this
	 * class in any security sensitive project!
	 */
