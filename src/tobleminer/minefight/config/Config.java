package tobleminer.minefight.config;
...
import tobleminer.minefight.config.container.KillstreakConfig;
...
public class Config
{
	...
	public void read()
	{
		...
		if (makeConfig)
		{
			config.set("CombatClass.Sniper.Kit",
					"sniper:0,1;ARROW:0,64;CLAY_BALL:0,4;IRON_INGOT:0,2;WOOD_SWORD:0,1;IRON_PICKAXE:0,1;IRON_SPADE:0,1;IRON_AXE:0,1;DIRT:0,64;LADDER:0,32");
			...
			config.set("CombatClass.Heavy.Kit",
					"lmg:0,1;ARROW:0,64;ARROW:0,64;DIAMOND:0,1;INK_SACK:4,5;IRON_INGOT:0,2;IRON_PICKAXE:0,1;IRON_SPADE:0,1;IRON_AXE:0,1;DIRT:0,64;LADDER:0,32;BONE:0,3");
			...
			config.set("CombatClass.Engineer.Kit",
					"IRON_SWORD:0,1;WOOD_SWORD:0,1;IRON_INGOT:0,2;DISPENSER:0,1;ARROW:0,64;SULPHUR:0,16;IRON_PICKAXE:0,1;IRON_SPADE:0,1;IRON_AXE:0,1;DIRT:0,64;LADDER:0,32");
			...
			config.set("CombatClass.Medic.Kit",
					"IRON_SWORD:0,1;medigun:0,1;IRON_INGOT:0,2;IRON_PICKAXE:0,1;IRON_SPADE:0,1;IRON_AXE:0,1;DIRT:0,64;LADDER:0,32");
			...
			config.set("CombatClass.Pyro.Kit",
					"flamethrower:0,1;WOOD_SWORD:0,1;IRON_INGOT:0,2;IRON_PICKAXE:0,1;IRON_SPADE:0,1;IRON_AXE:0,1;BLAZE_POWDER:0,64;BLAZE_POWDER:0,64;DIRT:0,64;LADDER:0,32");
	...
	public void load()
	{
		if (this.file.exists())
		{
			...
			{
				Error error = new Error("Failed loading configuration!",
						"The pluginconfiguration could not be loaded: " + ex.getMessage(),
						"The plugin won't work until this error is fixed!", this.getClass().getName(),
	...
	public void save()
	{
		...
		catch (Exception ex)
		{
			Error error = new Error("Failed saving configuration!",
					"The pluginconfiguration could not be saved: " + ex.getMessage(),
					"The plugin won't work until this error is fixed!", this.getClass().getName(),
					ErrorSeverity.SEVERE);
			ErrorReporter.reportError(error);
		}
	...
	public List<Area3D> getProtectedAreasByWorld(World w)
	{
		...
		Error err = new Error("Tried to get protected regions for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
	...
	public Location getRoundEndSpawnForWorld(World w)
	{
		...
		Error err = new Error("Tried to fetch leave world for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public Area3D getRespawnForWorld(World w)
	{
		...
		Error err = new Error("Tried to fetch respawn point for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public Area3D getSpawnForWorld(World w)
	{
		...
		Error err = new Error("Tried to fetch spawn point for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean isGamemodeEnabledInWorld(World w, Gamemode gmode)
	{
		...
		Error err = new Error("Tried to get gmode enabled for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public int getPointsForGamemodeInWorld(World w, Gamemode gmode)
	{
		...
		Error err = new Error("Tried to get max tickets for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public void addInfoSign(Sign sign, Gamemode gm)
	{
		...
		Error err = new Error("Tried to add info sign to unknown world.",
				String.format("World: \"%s\"", sign.getWorld().getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	}
	...
	public void removeInfoSign(Sign sign, Gamemode gm)
	{
		...
		Error err = new Error("Tried to remove info sign from unknown world.",
				String.format("World: \"%s\"", sign.getWorld().getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public List<Sign> getInfoSigns(World world, Gamemode gm)
	{
		...
		Error err = new Error("Tried to get info signs for unknown world.",
				String.format("World: \"%s\"", world.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean getPreventItemDropOnDeath(World world, Gamemode gm)
	{
		...
		Error err = new Error("Tried to get prevent item drop on death for unknown world.",
				String.format("World: \"%s\"", world.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean getPreventItemDrop(World world, Gamemode gm)
	{
		...
		Error err = new Error("Tried to get prevent item drop for unknown world.",
				String.format("World: \"%s\"", world.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public void addFlag(FlagContainer fc)
	{
		...
		Error err = new Error("Tried to add flag to unknown world.",
				String.format("World: \"%s\"", fc.sign.getWorld().getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	}
	...
	public void removeFlag(Sign sign)
	{
		...
		Error err = new Error("Tried to remove flag from unknown world.",
				String.format("World: \"%s\"", sign.getWorld().getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public List<FlagContainer> getFlags(World world)
	{
		...
		Error err = new Error("Tried to get flags for unknown world.", String.format("World: \"%s\"", world.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getFlagCaptureDistance(World w)
	{
		...
		Error err = new Error("Tried to remove flag from unknown world.", String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
		return 10d;
	...
	public double getFlagCaptureSpeed(World w) // % per second
	{
		...
		Error err = new Error("Tried to get flag capture speed for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getFlagCaptureAcceleration(World w)
	{
		...
		Error err = new Error("Tried to get flag capture acceleration for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getPointlossPerFlagPerSecond(World w)
	{
		...
		Error err = new Error("Tried to get flag pointloss for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean getLosePointsWhenEnemyHasLessThanHalfFlags(World w)
	{
		...
		Error err = new Error("Tried to get lose points when enemy has less than half flags for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean getAutobalance(World w, Gamemode gm)
	{
		...
		Error err = new Error("Tried to get autobalance for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public List<RadioStationContainer> getRadioStations(World world)
	{
		...
		Error err = new Error("Tried to get radio stations for unknown world.",
				String.format("World: \"%s\"", world.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public void addRadioStation(RadioStationContainer rsc)
	{
		...
		Error err = new Error("Tried to add radio station to unknown world.",
				String.format("World: \"%s\"", rsc.sign.getWorld().getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	}
	...
	public void removeRadioStation(Sign sign)
	{
		...
		Error err = new Error("Tried to remove radio station from unknown world.",
				String.format("World: \"%s\"", sign.getWorld().getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getRadioStationDestructTime(World w)
	{
		...
		Error err = new Error("Tried to get radio station detonation time for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getDefenderInnerSpawnRadius(World w)
	{
		...
		Error err = new Error("Tried to get inner defender spawn radius for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getDefenderOuterSpawnRadius(World w)
	{
		...
		Error err = new Error("Tried to get outer defender spawn radius for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getAttackerInnerSpawnRadius(World w)
	{
		...
		Error err = new Error("Tried to get inner attacker spawn radius for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getAttackerOuterSpawnRadius(World w)
	{
		...
		Error err = new Error("Tried to get outer attacker spawn radius for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public void addNewProtectedRegion(Location pos1, Location pos2)
	{
		...
		{
			Error err = new Error("Tried to register protection for unknown world.",
					String.format("World: \"%s\"", pos1.getWorld().getName()),
					"This probably means that your configuration isn't up to date.", this.getClass().getName(),
					ErrorSeverity.WARNING);
			ErrorReporter.reportError(err);
		}
	...
	public boolean isFalldamageActive(World w, Gamemode gm)
	{
		...
		Error err = new Error("Tried to get falldamage active for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean isHungerActive(World w, Gamemode gm)
	{
		...
		Error err = new Error("Tried to get hunger active for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean isMpvpEnabled(World w)
	{
		...
		Error err = new Error("Tried to get mpvp enabled for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean isMinimapEnabled(World w)
	{
		...
		Error err = new Error("Tried to get minimap enabled for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getProjectileDamage(World w, Gamemode g)
	{
		...
		Error err = new Error("Tried to get projectile damage for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getHeadshotDamageMultiplier(World w, Gamemode g)
	{
		...
		Error err = new Error("Tried to get headshot multiplier for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getLegshotDamageMultiplier(World w, Gamemode g)
	{
		...
		Error err = new Error("Tried to get legshot multiplier for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getCritProbability(World w, Gamemode g)
	{
		...
		Error err = new Error("Tried to get crit probability for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getCritMultiplier(World w, Gamemode g)
	{
		...
		Error err = new Error("Tried to get crit multiplier for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean canEnvironmentBeDamaged(Gamemode gmode, World w)
	{
		...
		Error err = new Error("Tried to get can environment be damaged for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean canExlosionsDamageEnvironment(Gamemode gmode, World w)
	{
		...
		Error err = new Error("Tried to get can explosions damage environment for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double getScore(World w, Score s)
	{
		...
		Error err = new Error(String.format("Tried to get score for action \"%s\" for unknown world.", s.name()),
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public int getInfoBeaconInterval(Gamemode gmode, World w)
	{
		...
		Error err = new Error("Tried to get infoBeaconInterval for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public PlayerSeekerContainer getPlayerSeekerConf(World w, Gamemode gmode)
	{
		...
		Error err = new Error("Tried to get playerSeekerContainer for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public KillstreakConfig getKillstreaks(World w, Gamemode gmode)
	{
		...
		Error err = new Error("Tried to get killstreaks for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public HashMap<String, CombatClass> getCombatClasses(WeaponIndex wi)
	{
		...
		for (String key : cs.getKeys(false))
		{
			...
			{
				Error err = new Error(String.format("The combat class '%s' couldn't be loaded!", key),
						String.format("The combat class '%s' isn't set up correctly.", key),
						"Check your configuration.", this.getClass().getName(), ErrorSeverity.ERROR);
				ErrorReporter.reportError(err);
				continue;
			}
	...
	public List<ItemStack> getKitFromString(String s, WeaponIndex wi)
	{
		...
		for (String kitItem : s.split(";"))
		{
			...
			{
				Error error = new Error("Error parsing combat-class information!",
						String.format("Check your mineFight.conf! Problem: '%s': ", kitItem) + ex.getMessage(),
						"There will be problems with the player-equipment until this is fixed.",
	...
	public ItemStack[] getArmorFromString(String s)
	{
		...
		for (String id : ids)
		{
			...
			{
				Error error = new Error("Error parsing combat-class information!",
						"Check your mineFight.conf! Problem: " + ex.getMessage(),
						"There will be problems with the player-equipment until this is fixed.",
						this.getClass().getName(), ErrorSeverity.ERROR);
				ErrorReporter.reportError(error);
			}
	...
	public boolean isSpawnengineEnabled(World w)
	{
		...
		Error err = new Error("Tried to get isSpawnengineEnabled for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double minEnemySpawnDistance(World w)
	{
		...
		Error err = new Error("Tried to get minEnemySpawnDistance for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double smallestLineOfSightAngle(World w)
	{
		...
		Error err = new Error("Tried to get smallestLineOfSightAngle for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public boolean isMinEnemySpawnDistance2D(World w)
	{
		...
		Error err = new Error("Tried to get isMinEnemySpawnDistance2D for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public double minProjectileDist(World w)
	{
		...
		Error err = new Error("Tried to get minProjectileDist for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
	...
	public Location getSpawnLookatPos(World w)
	{
		...
		Error err = new Error("Tried to get spawnLookatPos for unknown world.",
				String.format("World: \"%s\"", w.getName()),
				"This probably means that your configuration isn't up to date.", this.getClass().getName(),
				ErrorSeverity.WARNING);
		ErrorReporter.reportError(err);
