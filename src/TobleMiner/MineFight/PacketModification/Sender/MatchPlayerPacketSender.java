package TobleMiner.MineFight.PacketModification.Sender;
...
public class MatchPlayerPacketSender
{
	...
	public void sendNameUpdateTo(PVPPlayer watched, PVPPlayer watcher, boolean realName)
	{
		try
		{
			PacketContainer pc = pm.createPacketConstructor(Packets.Server.NAMED_ENTITY_SPAWN,watched.thePlayer).createPacket(watched.thePlayer);
